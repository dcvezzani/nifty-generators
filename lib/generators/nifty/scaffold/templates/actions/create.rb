  def create
    ...
    respond_to do |format|
      if @client.save
        format.html { redirect_to polymorphic_path([@client, :<%= instances_name %>], load_style: :partial), notice: '<%= class_name.underscore.humanize.downcase %> was successfully created.' }
